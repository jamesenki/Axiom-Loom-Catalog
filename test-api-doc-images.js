...
async function testApiDocImages() {
  ...
  console.log('Navigating to vehicle-to-cloud repository...');
  ...
  console.log('\nClicking "API and Protocol Reference" documentation link...');
  const docLink = page.locator('a:has-text("API and Protocol Reference")').first();
  await docLink.click();

  await page.waitForTimeout(3000);

  // Wait for documentation content to load
  await page.waitForSelector('text=Vehicle-to-Cloud Communications: API and Protocol Reference', { timeout: 10000 });
