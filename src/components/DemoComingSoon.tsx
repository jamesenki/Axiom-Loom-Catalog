...
import { ArrowLeft, Play, Zap, Settings } from 'lucide-react';
  ...
  return (
    <PageWrapper>
      ...
      <ContentContainer>
        ...
        <Title>Live Demo Coming Soon</Title>
        <Subtitle>Interactive Platform Preview in Development</Subtitle>
        
        <Description>
          We're building an immersive live demo environment for the Water Heater Fleet Platform. 
          Experience the full power of AI-powered predictive maintenance with real-time data, 
          interactive dashboards, and hands-on exploration of the platform's capabilities.
        </Description>

        <FeatureGrid>
          <FeatureCard>
            <FeatureIcon>🖥️</FeatureIcon>
            <FeatureTitle>Interactive Dashboard</FeatureTitle>
            <FeatureDescription>Real-time fleet monitoring and analytics</FeatureDescription>
          </FeatureCard>
          <FeatureCard>
            <FeatureIcon>🔮</FeatureIcon>
            <FeatureTitle>Predictive Analytics</FeatureTitle>
            <FeatureDescription>AI-powered failure prediction in action</FeatureDescription>
          </FeatureCard>
          <FeatureCard>
            <FeatureIcon>⚡</FeatureIcon>
            <FeatureTitle>Live Simulation</FeatureTitle>
            <FeatureDescription>Test scenarios with sample data</FeatureDescription>
          </FeatureCard>
        </FeatureGrid>
        ...
        <Footer>
          <p>
            Ready to explore? The interactive demo will showcase the platform's full capabilities.<br />
